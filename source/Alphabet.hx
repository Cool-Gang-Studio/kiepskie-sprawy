...
class AlphaCharacter extends FlxSprite
{
	...
	//                                           ą      ć      ę      ł      ń      ó     ś      ź      ż
	public static var lowerDiacritical:String = "\u{105}\u{107}\u{119}\u{142}\u{144}\u{F3}\u{15B}\u{17A}\u{17C}";


	
	public function createBoldDiacritical(letter:String)
	{
		switch (letter)
		{
			case '\u{105}': // ą
				animation.addByPrefix(letter, 'u105 bold', 24);
			case '\u{107}': // ć
				animation.addByPrefix(letter, 'u107 bold', 24);
			case '\u{119}': // ę
				animation.addByPrefix(letter, 'u119 bold', 24);
			case '\u{142}': // ł
				animation.addByPrefix(letter, 'u142 bold', 24);
			case '\u{144}': // ń
				animation.addByPrefix(letter, 'u144 bold', 24);
			case '\u{F3}': // ó
				animation.addByPrefix(letter, 'uF3 bold', 24);
			case '\u{15B}': // ś
				animation.addByPrefix(letter, 'u15B bold', 24);
			case '\u{17A}': // ź
				animation.addByPrefix(letter, 'u17A bold', 24);
			case '\u{17C}': // ż
				animation.addByPrefix(letter, 'u17C bold', 24);
		}
